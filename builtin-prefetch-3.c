...
int test_printf(const char *format, ...)
{
    ...
    if (test_output == NULL) {
	test_output = fopen("builtin-prefetch-3.c.output", "w");
    }
...
main(int argc, char**argv)
{
    ...
    {
	{"simple_vol_global", (void*)(long)-1},
	{"simple_vol_file", (void*)(long)-1},
	{"expr_vol_global", (void*)(long)-1},
	{"main", (void*)(long)-1},
	{"abort", (void*)my_abort},
	{"exit", (void*)test_exit},
...
""};
    ...
    for (i=0; i < 4; i++) {
        ...
        if (i == 3) {
            ...
            if (exit_value != 0) {
                printf("Test ./generated/builtin-prefetch-3.c failed\n");
                exit(exit_value);
            }
        }
    }
    if (test_output) {
        ...
        fclose(test_output);
        int ret = system("cmp builtin-prefetch-3.c.output /Users/eisen/prog/gcc-3.3.1-3/gcc/testsuite/gcc.expect-torture/execute/builtin-prefetch-3.expect");
        ret = ret >> 8;
        if (ret == 1) {
            printf("Test ./generated/builtin-prefetch-3.c failed, output differs\n");
            exit(1);
        }
        if (ret != 0) {
            printf("Test ./generated/builtin-prefetch-3.c failed, output missing\n");
            exit(1);
        }
    }
    if (verbose) printf("Test ./generated/builtin-prefetch-3.c Succeeded\n");
    return 0;
}
