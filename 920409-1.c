...
int test_printf(const char *format, ...)
{
    ...
    if (test_output == NULL) {
	test_output = fopen("920409-1.c.output", "w");
    }
...
""};
    ...
    for (i=0; i < 2; i++) {
        ...
        if (i == 1) {
            ...
            if (exit_value != 0) {
                printf("Test ./generated/920409-1.c failed\n");
                exit(exit_value);
            }
        } else {
    ...
    if (test_output) {
        ...
        if (ret != 0) {
            printf("Test ./generated/920409-1.c failed, output missing\n");
            exit(1);
        }
    }
    if (verbose) printf("Test ./generated/920409-1.c Succeeded\n");
    return 0;
}
