...
my %gcc_exceptions =  ( "20000205-1" => "Recurses",
		     ...
		     "20000801-3" => "Uses empty struct",
		     "20000815-1" => "Uses bitfields",
		     "20000818-1" => "Uses #if",
		     "20000822-1" => "Uses #if",
		     "20000910-1" => "Init with address",
		     "20000914-1" => "Uses union",
		     "20000917-1" => "Uses on-the-fly struct expression like: (int3) { 1, 1, 1 }",
		     "20001026-1" => "structure return",
		     "20001011-1" => "Tests __FUNCTION__",
		     "20001203-2" => "Uses union",
		     "20001228-1" => "Uses union",
		     "20001229-1" => "Uses #if",
		     "20010209-1" => "Nested function",
		     "20010119-1" => "Uses #if",
		     "20010122-1" => "Uses #define",
		     "20010124-1" => "Uses union",
		     "20010518-2" => "Packed attribute test",
		     "20010605-1" => "Nested function",
		     ...
		     "920710-1" => "requires unsigned long long",
		     "920721-2" => "GCC var array size extension",
		     "920721-4" => "Uses #if",
		     "920726-1" => "Uses stdarg.h",
		     "920908-1" => "Uses stdarg.h",
		     "920908-2" => "Uses bitfields",
		     "920909-1" => "No CASE!",
		     "920929-1" => "GCC var array size extension",
		     "921007-1" => "Uses #define",
		     "921016-1" => "Uses bitfields",
		     "921017-1" => "Uses #if",
		     "921110-1" => "Uses function pointers",
		     "921112-1" => "Uses union",
		     ...
		     "930406-1" => "Uses #if",
		     "930603-3" => "No CASE!",
		     "930608-1" => "Uses function pointers",
		     "930930-2" => "Uses union",
		     "931002-1" => "Uses #if",
		     ...
		     "991118-1" => "Uses bitfields",
		     "991201-1" => "Init with address",
		     ...
		     "struct-ret-1" => "Uses function pointers",
		     "tstdi-1" => "Uses #define",
